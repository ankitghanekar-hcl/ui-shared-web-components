      ...
      h(
        ...
        h(
          ...
          h(
            ...
            h('div', { class: 'close-icon' }, h('ui-icon', { icon: 'close', size: '36', color: 'red' })),
          ),
        ),
        h(
          'div',
