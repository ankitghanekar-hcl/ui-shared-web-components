const NAMESPACE = 'shared-web-components';
const BUILD = /* shared-web-components */ {
  allRenderFn: true,
...
const Env = /* shared-web-components */ {};
...
const initializeComponent = async (elm, hostRef, cmpMeta, hmrVersionId, Cstr) => {
  ...
  if ((BUILD.lazyLoad || BUILD.hydrateServerSide || BUILD.style) && (hostRef.$flags$ & 32) /* hasInitializedComponent */ === 0) {
    if (BUILD.lazyLoad || BUILD.hydrateClientSide) {
      ...
      customElements.whenDefined(cmpMeta.$tagName$).then((/* isWatchReady */) => (hostRef.$flags$ |= 128));
    }
    if (BUILD.style && Cstr.style) {
      ...
      if (!styles.has(scopeId)) {
        ...
        if (!BUILD.hydrateServerSide && BUILD.shadowDom && BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
          style = await import('./shadow-css-cb9467bd.js').then(m => m.scopeCss(style, scopeId, false));
        }
    ...
    if (!((hostRef.$flags$ & 1) /* hasConnected */)) {
      ...
      if (BUILD.asyncLoading) {
        ...
        while ((ancestorComponent = ancestorComponent.parentNode || ancestorComponent.host)) {
          ...
          if (
            (BUILD.hydrateClientSide && ancestorComponent.nodeType === 1 /* ElementNode */ && ancestorComponent.hasAttribute('s-id') && ancestorComponent['s-p']) ||
