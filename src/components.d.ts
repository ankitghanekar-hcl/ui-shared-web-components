...
import { LineItem as LineItem1 } from './components/wishlist-sidebar/wishlist-sidebar';
...
declare global {
  ...
  interface HTMLWishlistSidebarElement extends Components.WishlistSidebar, HTMLStencilElement {}
  var HTMLWishlistSidebarElement: {
    prototype: HTMLWishlistSidebarElement;
    new (): HTMLWishlistSidebarElement;
  };
  interface HTMLElementTagNameMap {
    ...
    'wishlist-sidebar': HTMLWishlistSidebarElement;
  }
}
declare namespace LocalJSX {
  ...
  interface DesktopMenu {
    ...
    onShowWishlist?: (event: CustomEvent<void>) => void;
    settings?: any;
    wishlistCount?: number;
  }
  interface MobileMenu {
  ...
  interface IntrinsicElements {
    ...
    'top-bar': TopBar;
    'wishlist-sidebar': WishlistSidebar;
  }
}
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'wishlist-sidebar': LocalJSX.WishlistSidebar & JSXBase.HTMLAttributes<HTMLWishlistSidebarElement>;
    }
  }
}
