      ...
      <div class="header">
                ...
                <a href="/cart">
                  <div class="miniCart">
                    <svg viewBox="0 0 21 21" class="svg_bag">
                      ...
                      ></path>
                      <circle r="1.2898706" cy="7.3147874" cx="6.04037" class="circle1 whiteFill"></circle>
                      <circle class="whiteFill" cx="14.975083" cy="7.3147874" r="1.2898706"></circle>
                      <path
        ...
        <div class="top_navigation_desk">
          <div class="top-nav-link">
            <avon-link link="/products" color="rgb(29, 31, 34)">
              <span slot="link_slot">Products</span>
            </avon-link>
          </div>
          <div class="top-nav-link">
            <avon-link link="#" color="rgb(29, 31, 34)">
              <span slot="link_slot">Quick Shop</span>
            </avon-link>
          </div>
          <div class="top-nav-link">
            <avon-link link="#" color="rgb(29, 31, 34)">
              <span slot="link_slot">Offers</span>
            </avon-link>
          </div>
          <div class="top-nav-link">
            <avon-link link="#" color="rgb(29, 31, 34)">
              <span slot="link_slot">Avon Loves Blogs</span>
            </avon-link>
          </div>
          <div class="top-nav-link">
            <avon-link link="#" color="rgb(29, 31, 34)">
              <span slot="link_slot">REP HUB</span>
            </avon-link>
          </div>
        </div>
