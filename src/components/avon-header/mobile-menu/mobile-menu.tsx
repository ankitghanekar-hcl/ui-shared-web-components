            ...
            <div class="account">
              <svg viewBox="0 0 23.8 29.5" id="Svg_avatar-user">
                <path
                  ...
                  fill="currentColor"
                ></path>
                <ellipse cx="11.553617" cy="7.8760314" rx="7.9549513" ry="7.8760333" fill="currentColor"></ellipse>
              </svg>
            </div>
            <div class="cart-bag">
              <avon-link link="/cart">
                <svg viewBox="0 0 21 21" id="Svg_bag" slot="link_slot">
                  ...
                  ></path>
                  <circle r="1.2898706" cy="7.3147874" cx="6.04037" class="whiteFill"></circle>
                  ...
                  <path
                    ...
                    class="whiteFill"
                  ></path>
                  <path d="m 2.9258041,2.1867649 15.2267659,0 -1.22695,1.2584104 0.471903,0.5977449 -13.7481329,0 0.5033641,-0.5977449 z" class="whiteFill"></path>
                </svg>
              </avon-link>
